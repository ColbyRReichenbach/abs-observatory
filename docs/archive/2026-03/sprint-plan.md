...
> Execution history and detailed sprint notes live here, but canonical product decisions now live in [product-source-of-truth.md](../../product/product-source-of-truth.md).
...
Backend companion: [sprint-9-backend-plan.md](./sprint-9-backend-plan.md)
