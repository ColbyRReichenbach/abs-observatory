...
| Challenges missing horizontal location | 5 | WARN | Missing px forces weaker geometry reasoning. |
| Challenges missing vertical location | 5 | WARN | Missing pz forces weaker geometry reasoning. |
