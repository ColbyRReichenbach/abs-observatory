...
This file tracks the product direction at a high level.

It is intentionally concise. Detailed sprint execution belongs in archive or task-specific planning docs, not in the current roadmap.
...
- live pregame/live/final game hubs
...
This roadmap should not be read as evidence that AiBS already ships:

- fully mature optimization-grade review strategy modeling
- fully separate org and fan products
- complete multi-provider live AI runtime
- fully productized warehouse / object-store / Redis platform layers
