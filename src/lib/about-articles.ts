...
export const ABOUT_ARTICLES: AboutArticle[] = [
  ...
  },
  {
    slug: "about-me",
    title: "About Me",
    dek: "How I approach product work, technical accountability, and the standard I want this system to meet.",
    authorName: "Colby Reichenbach",
    articleType: "founder",
    publishedAt: "2026-03-24",
    ...
    leadParagraphs: [
      "I built AiBS myself across product design, frontend systems, backend infrastructure, data ingestion, database modeling, statistical modeling, AI tooling, and the writing layer around the product. I wanted the interface, the data model, the analytics, and the explanations to agree with each other instead of feeling like separate projects stitched together at the end.",
      "My background shapes how I write and how I build models. I was a biology major, so I default to a more scientific style: detailed, concise, evidence-first, and much more interested in whether the logic holds up than in whether the writing sounds polished.",
      "That is the standard I want this system to meet. If I make a claim, I want it to be auditable. If I use a model publicly, I want the assumptions and limits to be explicit. If I build a page, I want it to answer a real baseball question instead of just looking sophisticated.",
    ],
    quickFacts: [
    ...
    sections: [
      {
        eyebrow: "How I build",
        heading: "I want the explanation and the implementation to agree.",
        paragraphs: [
          "One of my recurring rules on AiBS is that the public explanation should match the implementation. If I say a model is audited, there should be scripts, thresholds, or artifacts behind that statement. If a page says it is driven by run expectancy or win expectancy, the logic should exist in the codebase and the supporting data should exist in the database. If a chart has AI attached to it, that AI surface should be bounded and observable.",
          "The About desk exists for that reason. I do not want the most important implementation details buried in source code or implied through marketing language. I want them stated directly.",
        ],
      },
      {
        eyebrow: "What matters most",
        heading: "I care more about whether the system can defend itself than whether it sounds impressive.",
        paragraphs: [
          "A narrower product with clear boundaries is stronger than a broader one with blurry claims. That principle is why some AI surfaces stay bounded or gated, some metrics only appear where I can explain them, and these technical pages stay direct about data quality, sample size, and model limits.",
          "I am not trying to make the project sound advanced. I am trying to build something that holds up when a technical reader, a baseball reader, or an everyday fan asks the same question: is this actually true?",
        ],
      },
    ],
