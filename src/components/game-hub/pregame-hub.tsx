...
export async function PregameScoutingReport({ game }: { game: GameHubGame }) {
    ...
    return (
        <div className="py-8">
            <MotionIn>
                ...
                {/* S5-1: Umpire Zone Briefing — 4-quadrant grid with overturn rate callout */}
                {intel && (
                ...
                {/* S5-2: Challenge Timing History — per-inning challenge frequency */}
                {intel && (
                    <section className="mt-8">
                        <div className="panel p-8 shadow-2xl shadow-black/[0.02] border border-gray-50 bg-white">
                            <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-6 flex items-center gap-2">
                ...
                {/* S5-3: Umpire × Team History Block — the killer feature */}
                {intel && (
                    <section className="mt-8">
                        <div className="panel p-8 shadow-2xl shadow-black/[0.02] border border-gray-50 bg-white">
                            <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-6 flex items-center gap-2">
